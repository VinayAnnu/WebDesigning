...
//let helloWorldFunction = (req, res) => res.send('Hello World! Good Morning')
//let printExample = (req,res) => res.send("print the example first")

/*let testRoute = (req, res) => {
    console.log(req.params)
    res.send(req.params) //sending an object
}// end testRoute
